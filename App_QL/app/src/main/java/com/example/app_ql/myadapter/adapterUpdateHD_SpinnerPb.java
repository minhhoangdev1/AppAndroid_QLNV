...
import com.example.app_ql.ActivityUpdateHD;
import com.example.app_ql.R;
import com.example.app_ql.mymodel.phongban;

import java.util.ArrayList;

public class adapterUpdateHD_SpinnerPb extends BaseAdapter {
    private ActivityUpdateHD context;
    private ArrayList<phongban> ArrayListPhongban;

    public adapterUpdateHD_SpinnerPb(ActivityUpdateHD context, ArrayList<phongban> arrayListPhongban) {
